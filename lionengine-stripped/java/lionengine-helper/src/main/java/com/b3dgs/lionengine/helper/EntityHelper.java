 ...
 *
 * Stripped variant for C/SDL2 port reference: dropped feature dependencies
 * removed (attackable, collidable.framed, collidable.selector, networkable,
 * producible, tile.map.extractable, tile.map.transition.fog,
 * tile.map.pathfinding) — those subpackages were stripped in earlier passes.
 */
