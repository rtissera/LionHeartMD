...
/**
 * Test the formula add action.
 */
@RunWith(SWTBotJunit4ClassRunner.class)
public class AddFormulaTest
{
    private static final SWTBot BOT = new SWTBot();

    /**
     * Test the formula add.
     */
    @Test
    public void testFormulaAdd()
    {
        ...
        BOT.tree(0)
           ...
           .getNode("resources")
           .contextMenu(UtilNl.get("menu.formulas-add"))
           .click();
        ...
        final File file = new File(projectFolder, UtilFolder.getPath("resources", CollisionFormulaConfig.FILENAME));
        ...
        BOT.waitUntil(Conditions.shellIsActive(com.b3dgs.lionengine.editor.formula.editor.Messages.Title));
