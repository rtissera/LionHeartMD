...
import com.b3dgs.lionengine.swt.MediaMock;
import com.b3dgs.lionengine.swt.UtilAssert;

/**
 * Test the factory graphic provider class.
 */
final class FactoryGraphicSwtTest
{
    /** Logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(FactoryGraphicSwtTest.class);
    ...
    {
        assertNotNull(Graphics.createScreen(new Config(UtilAssert.RESOLUTION_320_240, 32, true)));
    }
    ...
    {
        assertNotNull(Graphics.createScreen(new Config(UtilAssert.RESOLUTION_320_240, 32, false)));
    }
