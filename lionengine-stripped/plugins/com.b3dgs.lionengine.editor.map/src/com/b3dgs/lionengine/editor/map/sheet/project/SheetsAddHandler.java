...
{
    /** Logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(SheetsAddHandler.class);
    ...
    public void execute(Shell parent)
    {
        ...
        {
            final Xml root = new Xml(UtilFile.removeExtension(TileSheetsConfig.NODE_TILE_SHEETS));
            try
            {
