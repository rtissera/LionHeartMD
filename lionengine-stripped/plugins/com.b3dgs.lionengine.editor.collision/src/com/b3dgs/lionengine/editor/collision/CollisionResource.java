...
/**
 * Collision resource checker.
 */
public class CollisionResource implements ResourceChecker
{
    /** Collisions file icon. */
    private static final Image ICON = UtilIcon.get(ProjectTreeCreator.RESOURCES_FOLDER, "collisions.png");
    ...
    {
        if (CollisionsTester.isCollisionsFile(media))
        {
            CollisionsMapEditHandler.executeHandler(shell);
            return true;
        }
        return false;
    }
