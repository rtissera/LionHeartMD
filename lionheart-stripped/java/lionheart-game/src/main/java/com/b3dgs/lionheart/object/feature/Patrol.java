...
public final class Patrol extends FeatureModel implements XmlLoader, RoutineUpdate, TileCollidableListener,
                          CollidableListener, Snapshotable, Recyclable
{
    ...
    public void update(double extrp)
    {
        ...
        // network strip: tickSync + sync removed (single-player only)
    }
    ...
    // network strip: onReceived removed
