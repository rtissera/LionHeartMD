...
public final class Stats extends FeatureModel implements Snapshotable, Recyclable
{
    ...
    {
        // network strip: client branch removed, always run as single-player owner
    ...
    {
        // network strip: client branch removed
    ...
    // network strip: syncApply + syncHurt removed (single-player only)
    ...
    // network strip: onReceived removed (Syncable interface removed)
